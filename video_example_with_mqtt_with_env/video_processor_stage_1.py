...
if __name__ == '__main__':
    ...
    mqtt_outgoing_topic = os.environ['MQTT_OUTGOING_TOPIC']
    redis_ip = os.environ['REDIS_IP']
    redis_port = int(os.environ['REDIS_PORT'])
    redis_db = int(os.environ['REDIS_DB'])
    redis_key = os.environ['REDIS_KEY']
    id = redis_key.split('_')[-1]
    ...
    print(mqtt_broker_ip, mqtt_broker_port, mqtt_incoming_topic, mqtt_outgoing_topic)
    processor = VideoProcessor1(f'processor_stage_1_instance_{id}', mqtt_incoming_topic, mqtt_outgoing_topic, 1, {}, mqtt_broker_ip, mqtt_broker_port)
    processor.run()
